...
public class Listeners implements ITestListener, IReporter , IRetryAnalyzer, IAnnotationTransformer{
    // Classlarimiz ile Listeners lara kac sekilde ulasiriz.
    //1. yol utilities te olusturlulan Listners ann. ile classtan cagirabiliriz.
    ...
    // Testin baslamasi depensOn a göre baska bir test basgli ve o testimiz fail old. durumda alririz
    @Override
